...
class NovaBackupConverter(
    ...
    suspend fun parseInfo(): NovaBackupInfo = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val itemCount = countItems(dbFile)

            NovaBackupInfo(novaConfig.columns, novaConfig.rows, novaConfig.dockCols, itemCount, novaConfig.iconPackPackage)
        } finally {
    ...
    private fun countItems(dbFile: File): Int {
